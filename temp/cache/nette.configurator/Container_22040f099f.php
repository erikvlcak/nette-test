<?php
// source: C:\web\BE\nette-test/config/common.neon
// source: C:\web\BE\nette-test/config/services.neon
// source: array
...
class Container_22040f099f extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Post\PostPresenter' => [2 => ['application.4']],
	...
	public function createServiceApplication__4(): App\UI\Post\PostPresenter
	{
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\web\BE\nette-test/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\web\BE\nette-test/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_22040f099f $container,
			) {
			}
